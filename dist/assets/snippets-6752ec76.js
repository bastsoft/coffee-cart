const snippets = {
  ...
  seo: {
    ...
    "Gremlins.js Bookmarklet"() {
      (function() {
        function callback() {
          gremlins.createHorde({ species: [gremlins.species.clicker(), gremlins.species.toucher(), gremlins.species.formFiller(), gremlins.species.scroller(), gremlins.species.typer()], mogwais: [gremlins.mogwais.alert(), gremlins.mogwais.fps(), gremlins.mogwais.gizmo()], strategies: [gremlins.strategies.distribution()] }).unleash();
        }
        var s = document.createElement("script");
    ...
    "корзина в рублях"() {
      fetch("https://openexchangerates.org/api/latest.json?app_id=970030463657472880e8bab3f3ac8e38").then((response) => response.json()).then((data) => {
        console.log(data);
...
//# sourceMappingURL=snippets-6752ec76.js.map
